...
CHART_PHRASES: dict[str, str] = {
    ...
    "Average Order Value (AOV) by Customer Segment": "各客户分类客单价 (AOV)",
    "Average Order Value (AOV) by Market · Top 15": "各市场客单价 (AOV) · 前15",
    ...
    "New vs. Returning Customers (B2C)": "新客 vs 老客 (B2C)",
    "Key Countries — Last 3 Months Revenue (重点国家)": "重点国家 — 近3个月营业额",
    "Revenue by Channel (会员来源, B2C)": "各渠道来源营业额（会员来源，B2C）",
